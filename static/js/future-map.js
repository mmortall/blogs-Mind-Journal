(function () {
  ...
  const copyByLanguage = {
    en: { proposal: "Proposal", caveat: "Critical caveat", region: "Region", status: "Status", open: "Open source", yes: "yes", no: "no", unit: "Record type", scope: "Scope", reviewed: "Map reviewed", mechanism: "Compared mechanism", mechanismDefault: "The mechanism represented by this entry; not a complete ideology", links: "Mind Journal and original materials", article: "Mind Journal article", shown: "entries shown", empty: "No entries match these filters.", fullscreen: "Full screen", exitFullscreen: "Exit full screen", fit: "Fit map", left: "public / resource planning", center: "hybrid coordination", right: "market / private autonomy", top: "participatory / direct democracy", bottom: "expert / technocratic control", xAxis: "Economic coordination", yAxis: "Political agency", kinds: { person: "person", people: "people", organization: "organisation", project: "project", software: "software", source: "source", research: "research", local: "local reference" }, scopes: { direct: "direct", adjacent: "adjacent", tool: "tool", reference: "reference" } },
    ru: { proposal: "Что предлагают", caveat: "Критическая оговорка", region: "Регион", status: "Статус", open: "Открытый код", yes: "да", no: "нет", unit: "Тип записи", scope: "Контекст", reviewed: "Дата ревью карты", mechanism: "Сравниваемый механизм", mechanismDefault: "Механизм, представленный этой записью; не полная идеология", links: "Mind Journal и оригинальные материалы", article: "Статья Mind Journal", shown: "позиций показано", empty: "По этим фильтрам ничего не найдено.", fullscreen: "На весь экран", exitFullscreen: "Выйти из полноэкранного режима", fit: "Вписать карту", left: "общественное / ресурсное планирование", center: "смешанная координация", right: "рынок / частная автономия", top: "участие / прямая демократия", bottom: "экспертное / технократическое управление", xAxis: "Экономическая координация", yAxis: "Политическое участие", kinds: { person: "человек", people: "люди", organization: "организация", project: "проект", software: "ПО", source: "источник", research: "исследование", local: "локальная справка" }, scopes: { direct: "прямой спор", adjacent: "смежная область", tool: "инструмент", reference: "справочный слой" } },
    uk: { proposal: "Що пропонують", caveat: "Критичне застереження", region: "Регіон", status: "Статус", open: "Відкритий код", yes: "так", no: "ні", unit: "Тип запису", scope: "Контекст", reviewed: "Дата перегляду мапи", mechanism: "Порівнюваний механізм", mechanismDefault: "Механізм, представлений цим записом; не повна ідеологія", links: "Mind Journal та оригінальні матеріали", article: "Стаття Mind Journal", shown: "позицій показано", empty: "За цими фільтрами нічого не знайдено.", fullscreen: "На весь екран", exitFullscreen: "Вийти з повноекранного режиму", fit: "Вписати мапу", left: "суспільне / ресурсне планування", center: "змішана координація", right: "ринок / приватна автономія", top: "участь / пряма демократія", bottom: "експертне / технократичне управління", xAxis: "Економічна координація", yAxis: "Політична участь", kinds: { person: "людина", people: "люди", organization: "організація", project: "проєкт", software: "ПЗ", source: "джерело", research: "дослідження", local: "локальна довідка" }, scopes: { direct: "прямий спір", adjacent: "суміжна сфера", tool: "інструмент", reference: "довідковий шар" } }
  };
  ...
  function init(root) {
    ...
    function showDetails(node) {
      ...
      addDetail(details, copy.unit, `${copy.kinds[node.kind] || node.kind} · ${copy.scopes[node.scope] || node.scope || "—"}`);
      addDetail(details, copy.mechanism, localized(node.coordinate_subject, language) || localized(node.proposal, language) || copy.mechanismDefault);
      ...
      addDetail(details, copy.reviewed, data.reviewed_at || "—");
