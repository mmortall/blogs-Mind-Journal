...
const quickLinks = 'Результати';
const searchResultsLabel = 'Результати пошуку';
const shortSearchQuery = 'Запит надто короткий'
const typeToSearch = 'Введіть текст для пошуку';
const noMatchesFound = 'Збігів не знайдено';
